          ...
          axios.post(`${LOCALTUNNEL}/users`,
            {
              ...
              username: username,
              friends: [{ firebaseID: 'igyWVxSUN3Rvei7O41KfNCpCTYY2', username: 'SeanMaac', profilePicURI: 'https://res.cloudinary.com/cwhrcloud/image/upload/v1669246271/orange_auy0ff.png' }]
            })
